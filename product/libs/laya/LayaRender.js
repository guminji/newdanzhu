...
(function() {
	...
	var _createBodySprite = function(render, body) {
		...
		switch (typeof texturePath) {
			case 'string':
				sprite.loadImage(texturePath);
				break;
			case 'object':
				sprite.size(texturePath.width, texturePath.height);
				sprite.graphics.drawTexture(texturePath, 0, 0, texturePath.width, texturePath.height);
				break;
		}
